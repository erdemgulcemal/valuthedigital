...
const PlanProfessional = () => {
    ...
    // Set page title
    useEffect(() => {
        document.title = "Valuthe Digital - Professional Planı";
    }, []);
    ...
    const featureCards = [
        {
            icon: Monitor,
            title: "10 Sayfa Web Sitesi",
            description: "Genişletilmiş sayfa yapısı",
            gradient: "from-blue-500 to-cyan-500"
        },
        {
            icon: Database,
            title: "E-posta Entegrasyonu",
            description: "E-posta entegrasyonu",
            gradient: "from-emerald-500 to-teal-500"
        },
        {
            icon: Settings,
            title: "Özel Admin Paneli",
            description: "Kolay içerik güncellemesi",
            gradient: "from-purple-500 to-pink-500"
        },
        {
            icon: Headphones,
            title: "6 Ay Ücretsiz Destek",
    ...
    return (
        <div className="min-h-screen bg-gray-900 page-transition overflow-x-hidden relative">
            ...
            <div className="fixed inset-0 z-0">
                <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-purple-900/15 to-pink-900/20"></div>
                <div
                    className="absolute inset-0 opacity-20"
                    style={{
                        background: `radial-gradient(circle at ${mousePosition.x}% ${mousePosition.y}%, rgba(147, 51, 234, 0.1) 0%, transparent 60%)`,
                    }}
                ></div>
            ...
            <main className="pt-20 sm:pt-32 pb-12 relative z-10">
                ...
                <section id="hero" className="py-12 sm:py-20 relative overflow-hidden">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-full border border-purple-500/30 mb-6 sm:mb-8">
                            <Crown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-purple-400 animate-pulse" />
                            <span className="text-purple-400 text-xs sm:text-sm font-medium">En Popüler Paket</span>
                        </div>
                        ...
                        <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto mb-12 sm:mb-16">
                            Büyüyen işletmeler için profesyonel web çözümleri. Gelişmiş özellikler ve uzun süreli destek.
                        </p>
                    </div>
                </section>
                ...
                <section id="paket-detaylari" className="py-12 sm:py-20 relative">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="relative group rounded-2xl p-1 bg-gradient-to-br from-purple-500 via-pink-500 to-purple-600 shadow-xl shadow-purple-500/20 hover:scale-105 transition-all duration-500">
                            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10 bg-gradient-to-r from-pink-500 to-purple-500 text-white px-4 sm:px-6 py-1 sm:py-1.5 rounded-full text-xs sm:text-sm font-bold whitespace-nowrap shadow-lg animate-pulse-subtle">
                                En Popüler
                            </div>
                            ...
                            <div className="bg-gray-900 rounded-xl p-6 sm:p-8 text-center relative overflow-hidden">
                                ...
                                <div className="relative">
                                    ...
                                    <button className="w-full sm:w-4/5 mx-auto py-2.5 sm:py-3 rounded-lg font-medium text-xs sm:text-sm transition-all duration-300 bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 text-white hover:opacity-90 hover:scale-105 shadow-lg">
                                        Projeye Başla
                                    </button>
                                </div>
                            </div>
                ...
                <section id="karsilastirma" className="py-12 sm:py-20 bg-gray-900 relative overflow-hidden">
                    <div className="absolute inset-0">
                        <div className="absolute top-0 left-1/3 w-[20rem] sm:w-[40rem] h-[20rem] sm:h-[40rem] bg-purple-500/5 rounded-full blur-3xl"></div>
                        <div className="absolute bottom-0 right-1/3 w-[20rem] sm:w-[40rem] h-[20rem] sm:h-[40rem] bg-pink-500/5 rounded-full blur-3xl"></div>
                    </div>

                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        <div className="text-center mb-12 sm:mb-16">
                            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-full border border-blue-500/30 mb-6 sm:mb-8">
                                <BarChart3 className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-400" />
                                <span className="text-blue-400 text-xs sm:text-sm font-medium">Plan Karşılaştırması</span>
                            </div>
                            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 sm:mb-8">
                            ...
                            {comparisonPlans.map((plan, index) => (
                                <div
                                    ...
                                    className={`relative group rounded-2xl p-0.5 transition-all duration-500 ${plan.isActive
                                        ? `bg-gradient-to-br ${plan.gradient} shadow-xl shadow-purple-500/20 hover:scale-105 scale-105 ring-2 ring-purple-500/50`
                                ...
                                >
                                    ...
                                    <div className="bg-gray-900 rounded-xl p-6 sm:p-8 text-center relative overflow-hidden h-full flex flex-col">
                                        {(plan.name === "Professional") && <div className="absolute inset-0 bg-gradient-to-br from-gray-800/5 to-gray-700/5"></div>}
